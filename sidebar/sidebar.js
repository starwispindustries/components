...
const CustomButton = ({children, onClick, active}) => {
    return (
        <Button onClick={onClick} w="100%" variant={active ? "active_sidebar_button" : "sidebar_button"} size="sm" _focus={{outline: 'none'}}>
            {children}
        </Button>
    )
}
...
const SidebarContent = ({ onClick, active }) => {
    return (
        <VStack mt="29px" spacing="9px">
            ...
            <CustomButton onClick={onClick} active={active === "home"}>
                <CustomIcon>
            ...
            <CustomButton onClick={onClick} active={active === "class"}>
                <CustomIcon>
            ...
            <CustomButton onClick={onClick} active={active === "info"}>
                <CustomIcon>
...
const Sidebar = ({ isOpen, variant, onClose, active }) => {
    ...
    return variant === 'sidebar' ? (
        ...
        >
            ...
            <SidebarContent onClick={onClose} active={active} />
        </Box>
    ) : (
